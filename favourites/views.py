...
def view_favourites(request):
    ...
    context = {"favourites_products": favourites_products}
...
def add_favourite(request, product_id):
    ...
    if not request.user.is_authenticated:
        messages.error(request, "Sorry, you have to log in"
...
def remove_favourite(request, product_id, redirect_from):
    ...
    if product in favourites.products.all():
        ...
        messages.info(request, "Removed this product " "from your favourites!")
    else:
