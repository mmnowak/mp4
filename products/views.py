    ...
    if request.GET:
        ...
        if "product_type_name" in request.GET:
            ...
            products = products.filter(
             category__product_type_name__in=product_type)
            product_type = Category.objects.filter(
             product_type_name__in=product_type)
...
def product_detail(request, product_id):
    ...
    context = {"product": product, "in_favourites": in_favourites}
